...
public class UploadUtil {
	//阿里域名
	public static final String ALI_DOMAIN = "https://java-test-upload.oss-cn-guangzhou.aliyuncs.com/";
	...
	public static String uploadAli(MultipartFile file) throws Exception {
		...
		// 上传文件流。
		ossClient.putObject("java-test-upload", fileName, file.getInputStream());
		// 关闭OSSClient。
		ossClient.shutdown();
